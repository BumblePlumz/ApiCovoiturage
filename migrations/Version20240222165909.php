 ...
 */
final class Version20240222165909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, voiture_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(60) DEFAULT NULL, prenom VARCHAR(60) DEFAULT NULL, tel VARCHAR(12) DEFAULT NULL, pseudo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_FCEC9EFE7927C74 (email), UNIQUE INDEX UNIQ_FCEC9EF86CC499D (pseudo), INDEX IDX_FCEC9EF181A8BA (voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
